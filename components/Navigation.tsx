  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => store.navigate('/')}>
        ...
        <div className="hidden md:flex items-center gap-4">
          <button className="p-2 hover:bg-gray-100 rounded-full" onClick={() => store.navigate('/')}><Home className="w-5 h-5 text-gray-600" /></button>
          {user ? (
            <>
              <button className="p-2 hover:bg-gray-100 rounded-full relative" onClick={() => store.navigate('/messages')}><MessageSquare className="w-5 h-5 text-gray-600" /></button>
              <button className="p-2 hover:bg-gray-100 rounded-full"><Bell className="w-5 h-5 text-gray-600" /></button>
              <div className="flex items-center gap-2 ml-2 cursor-pointer hover:bg-gray-50 p-1 pr-3 rounded-full" onClick={() => store.navigate('/dashboard')}>
        ...
        <div className="md:hidden border-t border-gray-100 bg-white p-4 space-y-4">
          ...
          {!user && (
            <div className="flex flex-col gap-2">
              <Button variant="secondary" onClick={() => store.navigate('/login')}>Log In</Button>
